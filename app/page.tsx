...
export default function Home() {
  ...
  return <main className={dark ? "atlas-site dark" : "atlas-site"}>
    ...
    <section className="atlas-intro" id="top"><p className="atlas-kicker">Undergraduate degree planning</p><h1>See the whole program.<br />Understand every choice.</h1><p>Browse a TMU program semester by semester, inspect direct course relationships, explore compatible minors and search only the courses permitted in each requirement slot.</p></section>
    ...
    <section className="atlas-guide" id="guide"><p className="atlas-kicker">How to use Course Atlas</p><div><article><strong>1</strong><h3>Choose a program</h3><p>See all officially published academic periods together.</p></article><article><strong>2</strong><h3>Inspect courses and choices</h3><p>Course details stay beside the map. Elective searches stay inside the selected requirement.</p></article><article><strong>3</strong><h3>Try planning modes</h3><p>Overlay a compatible minor or mark completed courses in Eligibility Mode.</p></article></div><p className="site-disclaimer">Course Atlas is an independent planning aid for TMU students using the 2026-2027 Undergraduate Calendar. It does not replace your Academic Advisement Report, current course availability or advice from your program department.</p></section>
